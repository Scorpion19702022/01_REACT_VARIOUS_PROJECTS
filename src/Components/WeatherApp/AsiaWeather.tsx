...
import styles from './Styles/AsiaWeather.module.css'
...
const AsiaWeather = () => {
	const { refresh, citiesAsia, asiaCityTime } = useContext(AsiaContext)
	...
	return (
		<section className={styles.wrapper}>
			...
			<div className={styles.box_locale_time}>
				<h4 className={styles.city_locale_time}>Czas: Tokyo</h4>
				<span className={styles.locale_time}>{asiaCityTime}</span>
			</div>
